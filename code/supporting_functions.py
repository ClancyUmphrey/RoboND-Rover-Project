...
# The following processing is already handled in perception_step(), so could
# just set plotmap = Rover.worldmap and comment down to "Overlay obstacle"
      # ADD
      plotmap = Rover.worldmap 
